...
func main() {
	...
	router.Handle("/posts", mypkg.Auth(http.HandlerFunc(posts))).Methods("GET")
	router.Handle("/posts", mypkg.Auth(http.HandlerFunc(postPosts))).Methods("POST")
	router.Handle("/codes", mypkg.Auth(http.HandlerFunc(getCodes))).Methods("GET")
	router.Handle("/code/{id}", mypkg.Auth(http.HandlerFunc(getCode))).Methods("GET")
